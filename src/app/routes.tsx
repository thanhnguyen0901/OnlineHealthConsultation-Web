...
const PatientDashboardPage = lazy(() => import('@/features/patient/pages/PatientDashboardPage').then(m => ({ default: m.PatientDashboardPage })));
...
const UsersManagePage = lazy(() => import('@/features/admin/pages/UsersManagePage').then(m => ({ default: m.UsersManagePage })));
    ...
    <Suspense fallback={<div className="flex items-center justify-center min-h-screen"><Spinner size="lg" /></div>}>
      <Routes>
        ...
        <Route element={<AuthGuard><MainLayout /></AuthGuard>}>
          ...
          <Route path={ROUTE_PATHS.INBOX_QUESTIONS} element={<RoleGuard roles={['DOCTOR']}><InboxQuestionsPage /></RoleGuard>} />
          <Route path={ROUTE_PATHS.SCHEDULE} element={<RoleGuard roles={['DOCTOR']}><SchedulePage /></RoleGuard>} />
          
          {/* Admin routes */}
          <Route path={ROUTE_PATHS.ADMIN_DASHBOARD} element={<RoleGuard roles={['ADMIN']}><AdminDashboardPage /></RoleGuard>} />
          <Route path={ROUTE_PATHS.MANAGE_USERS} element={<RoleGuard roles={['ADMIN']}><UsersManagePage /></RoleGuard>} />
