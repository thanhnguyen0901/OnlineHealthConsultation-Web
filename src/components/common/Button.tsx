...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = outlined
    ? {
        primary:
          'border-2 border-blue-600 text-blue-600 hover:bg-blue-50 focus:ring-blue-500 dark:hover:bg-blue-900',
        secondary:
        ...
        danger:
          'border-2 border-red-600 text-red-600 hover:bg-red-50 focus:ring-red-500 dark:hover:bg-red-900',
      }
    : {
        primary:
  ...
  return (
    ...
    >
      ...
      {icon && <i className={`${icon} ${label || children ? 'mr-2' : ''}`} />}
      {label || children}
    </button>
  );
};
