    ...
    <div>
      ...
      <Card>
        <div className="mb-4 flex gap-4 flex-wrap">
          ...
          <div>
            <label className="block mb-2">{t('dateRange')}</label>
            <Calendar
              value={dateRange}
        ...
        <DataTable value={filteredAppointments} paginator rows={10} loading={loading} emptyMessage={t('noAppointments')}>
          ...
          <Column field="date" header={t('date')} body={dateBodyTemplate} sortable />
          <Column field="time" header={t('time')} sortable />
          <Column field="status" header={t('status')} body={statusBodyTemplate} style={{ width: '180px' }} />
        </DataTable>
      </Card>
    </div>
  );
