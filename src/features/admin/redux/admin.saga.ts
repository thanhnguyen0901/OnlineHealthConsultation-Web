...
function* handleLoadDoctors(action: PayloadAction<any>) {
  try {
    const result: { data: Doctor[]; pagination: any } = yield call(
      adminApi.getDoctors,
      action.payload
    );
...
function* handleLoadPatients(action: PayloadAction<any>) {
  try {
    const result: { data: Patient[]; pagination: any } = yield call(
...
function* handleUpdatePatient(action: PayloadAction<{ id: string; data: Partial<Patient> }>) {
  try {
    const patient: Patient = yield call(
      adminApi.updatePatient,
      action.payload.id,
      action.payload.data
    );
    ...
    yield put(
      addToast({
        ...
        detail: i18n.t('admin:patientUpdated'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
...
function* handleCreatePatient(
  ...
  try {
    const patient: Patient = yield call(adminApi.createPatient, action.payload);
    yield put(createPatientSucceeded(patient));
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:patientCreated'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
    yield put(createPatientFailed(msg));
    yield put(addToast({ severity: 'error', summary: i18n.t('common:error'), detail: msg }));
  }
}
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:patientDeactivated'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:userCreated'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:userUpdated'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:userDeleted'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:doctorCreated'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:doctorUpdated'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:doctorDeleted'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:specialtyCreated'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:specialtyUpdated'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:specialtyDeleted'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
...
function* handleLoadAppointments(action: PayloadAction<any>) {
  try {
    const result: { data: any[]; pagination: any } = yield call(
      adminApi.getAppointments,
      action.payload
    );
    yield put(
      loadAppointmentsSucceeded({ appointments: result.data, pagination: result.pagination })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:appointmentStatusUpdated'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:moderationApproved'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
  ...
  try {
    ...
    yield put(
      addToast({
        severity: 'success',
        summary: i18n.t('common:success'),
        detail: i18n.t('admin:moderationRejected'),
      })
    );
  } catch (error) {
    const msg = extractErrorMessage(error);
...
export function* adminSaga() {
  ...
  yield takeLatest(createPatientRequested.type, handleCreatePatient);
